...
public class ThaumcraftHelper {
  ...
  private static void registerItems_do() {
    ...
    addAspectRecipe((Block)ExtraUtils.transferPipe, new Object[] { Aspect.TRAVEL, Integer.valueOf(1), Aspect.ORDER, Integer.valueOf(1), Aspect.EARTH, Integer.valueOf(1) });
