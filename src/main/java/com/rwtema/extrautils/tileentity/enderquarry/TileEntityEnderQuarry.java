...
public class TileEntityEnderQuarry extends TileEntity implements IEnergyHandler {
  ...
  public enum DigType {
    NORMAL(null, 0),
    SILK((String)Enchantment.silkTouch, 1),
    FORTUNE((String)Enchantment.fortune, 1),
    FORTUNE2((String)Enchantment.fortune, 2),
    FORTUNE3((String)Enchantment.fortune, 3),
    SPEED((String)Enchantment.efficiency, 1),
    SPEED2((String)Enchantment.efficiency, 3),
    SPEED3((String)Enchantment.efficiency, 5);
