...
public class TileMiniChest extends TileEntity implements IInventory, IDynamicContainerProvider {
  ...
  public final InventoryBasic inv = new InventoryBasic("tile.extrautils:chestMini.name", false, 1);
  ...
  public DynamicContainer getContainer(EntityPlayer player) {
...
/* Location:              C:\Users\Emanuel\src\` decompile\mods\extrautilities-1.2.12-deobf.jar!\com\rwtema\extrautils\tileentity\chests\TileMiniChest.class
