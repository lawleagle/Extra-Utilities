            ...
            if (this.worldObj.getTotalWorldTime() - this.checkTimer > 100L) {
                ...
                if (this.worldObj.getBlock(this.xCoord + Facing.offsetsXForSide[dir], this.yCoord + Facing.offsetsYForSide[dir], this.zCoord + Facing.offsetsZForSide[dir]) == Blocks.cobblestone) {
                    ...
                    for (int i = 2; (!hasWater || !hasLava) && i < 6; i++) {
                        int _hasWater = hasWater ? 1 : 0;
                        int _hasLava = hasLava ? 1 : 0;
                        k = _hasWater | ((this.worldObj.getBlock(this.xCoord + Facing.offsetsXForSide[dir] + Facing.offsetsXForSide[i], this.yCoord + Facing.offsetsYForSide[dir], this.zCoord + Facing.offsetsZForSide[dir] + Facing.offsetsZForSide[i]).getMaterial() == Material.water) ? 1 : 0);
                        j = _hasLava | ((this.worldObj.getBlock(this.xCoord + Facing.offsetsXForSide[dir] + Facing.offsetsXForSide[i], this.yCoord + Facing.offsetsYForSide[dir], this.zCoord + Facing.offsetsZForSide[dir] + Facing.offsetsZForSide[i]).getMaterial() == Material.lava) ? 1 : 0);
                    }
                    if (k != 0 && j != 0)
