...
public class CommandTPSTimer extends CommandBase {
  ...
  public static String formatTimer(double time) {
    ...
    return String.format(Locale.ENGLISH, "%5.2f", new Object[] { Double.valueOf(time * 1.0E-6D) }) + "(" + (tpsDown ? (String)EnumChatFormatting.RED : "") + String.format(Locale.ENGLISH, "%5.2f", new Object[] { Double.valueOf(tps) }) + (tpsDown ? (String)EnumChatFormatting.RESET : "") + ")";
  }
